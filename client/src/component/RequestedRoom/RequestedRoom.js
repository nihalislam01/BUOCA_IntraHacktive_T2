...
import BookingDetails from "../OCA/BookingDetails/BookingDetails";
import Chat from "../Chat/Chat";
import RequestedRoomTable from "./RequestedRoomTable";

const bookRequestUrl = '/api/book/get/all';
    ...
    return (
        <>
            {!isDetails && !isThread && <>
                ...
                <hr />
                <RequestedRoomTable requests={requests} goToDetails={goToDetails} openThread={openThread}/>
            </>}
